...
const NAV: NavItem[] = [
  ...
  { to: "/dekani-attekintes", label: "Dékáni áttekintés", icon: Crown, roles: ["dekan"] },
  { to: "/vezetoi-attekintes", label: "Vezetői áttekintés", icon: GaugeCircle, roles: ["vezeto", "dekan", "szolgaltatasgazda", "admin"] },
