...
export const Route = createFileRoute("/dekani-attekintes")({
  head: () => ({
    meta: [
      { title: "Dékáni áttekintés – ÁOK Digitális Szolgáltatási Portál" },
      {
        name: "description",
        content:
          "Kari szintű dékáni irányítópult: minden digitális igény, projekt és költség egy nézetben, eset szintre lebontható.",
      },
      { property: "og:title", content: "Dékáni áttekintés – ÁOK Portál" },
      {
